...
const Cart = () => {
    ...
    const checkOutHandler = () => {
        if (isAuthenticated) {
          // User is authenticated, proceed to the shipping page
          navigate('/shipping');
        } else {
          // User is not authenticated, store cart items in local storage
          localStorage.setItem('cartItemsForGuest', JSON.stringify(cartItems));
