      ...
      <div className="nav">
        ...
        <div
          ...
          style={{
            ...
            background: `linear-gradient(to right, rgba(35,35,35), rgba(0,0,0,0.95))`,
        ...
        >
          <Link to="/" onClick={closeBarOnClick}>
            <img
        ...
        <div
          ...
          style={{
            flex: 20,
            transform: menuToggle ? "translateY(0)" : "translateY(-100vmax)",
            background: `linear-gradient(to right, rgba(0,0,0,0.95), rgba(35,35,35))`,
            ...
            <Link to={cartIconUrl} onClick={closeBarOnClick}>
              <img
                ...
                style={{
                  ...
                  width: link1Size,  // Set the width to match link size
                  height: link1Size, // Set the height to match link size
                  // Add more styles as needed
                }}
                className="icon" // Add a class for styling
              />
